...
{   
    ...
    char *ss = "UCInet Mobile Access";
    char* pp = "";
    char* constring = "HostName=Workout.azure-devices.net;DeviceId=sparkfun;SharedAccessKey=2E0gNp9ZNkMHKG2DgvSCR8U9ZXeRXjFwT9DI9HWYfF4=";
    ssid = ss;
    pass = pp;
